...
export default function CategoriesCourseManagement() {
  ...
  const { data: categoriesData } = useQuery({
    queryKey: ["categories", pageNumber, pageSize, keyword, sorts],
    queryFn: ({ queryKey }) => {
      ...
      return CategoriesCourseApi.getCategories(
        pageNumber,
        pageSize,
        keyword,
        sorts
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: CategoryCourseRequest }) =>
      CategoriesCourseApi.update(id, data),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => CategoriesCourseApi.delete(id),
    onSuccess: () => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Tổ chức các khóa học theo danh mục
          </p>
        </div>
            ...
            <Form {...createForm}>
              <form onSubmit={createForm.handleSubmit(handleCreateCategory)}>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Thêm danh mục để nhóm các khóa học liên quan.
                  </DialogDescription>
                </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Danh sách các danh mục khóa học</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-4">
            <Form {...searchForm}>
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            {...field}
                            placeholder="Tìm kiếm danh mục khoá học theo tên"
                            className="pl-8"
                          />
                        </div>
                      </FormControl>
